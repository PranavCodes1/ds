...
case 3:system("cls"); // equivalent to system("cls"); // equivalent to clrscr();
...
case 4:system("cls"); // equivalent to system("cls"); // equivalent to clrscr();
...
case 2:printf("Enter postition for node:");
...
case 5:system("cls"); // equivalent to system("cls"); // equivalent to clrscr();
...
case 6:system("cls"); // equivalent to system("cls"); // equivalent to clrscr();
...
printf("\nAddress of node with Data : %p",(void*)ptr);
